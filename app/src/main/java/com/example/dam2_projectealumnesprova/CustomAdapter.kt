...
class CustomAdapter(private val mList: List<AlumnesViewModel>) : RecyclerView.Adapter<CustomAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.textViewEdat.text = ItemsViewModel.edat
        holder.textViewCurs.text = ItemsViewModel.curs.toString()
